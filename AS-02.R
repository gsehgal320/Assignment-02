...
ggplot(StuPerform, aes(as.factor(parental.level.of.education),reading.score)) + geom_boxplot(fill="green", col="blue")
...
par(bg="lightgreen")
boxplot(StuPerform$math.score ~ StuPerform$parental.level.of.education, main = "Parental Education" , xlab = "Parental Level of Education", ylab = "Math Score", col = "blue")
